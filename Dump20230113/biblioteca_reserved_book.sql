...
CREATE TABLE `reserved_book` (
  ...
  KEY `FKryiighcwxp1webeqi7g4anl57` (`user_id`),
  CONSTRAINT `FKbn0ikattiq471vtyqrwlpdvbu` FOREIGN KEY (`book_id`) REFERENCES `books_table` (`id`),
  CONSTRAINT `FKryiighcwxp1webeqi7g4anl57` FOREIGN KEY (`user_id`) REFERENCES `users_table` (`id`)
...
-- Dump completed on 2023-01-13 22:29:54
